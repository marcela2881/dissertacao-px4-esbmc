...
int main() {
    ...
    // FAIR WINDOW: matches exactly the ESBMC sub-test
    // (test_gps_real_underflow_protection) that produced the
    // original FAILED counterexample (dump_buffer.len = 216).
    __CPROVER_assume(dump_buffer.len >= GPS_DUMP_DATA_SIZE - 10);
